...
(
	LM_ID int not null primary key,
    full_name varchar(25) NOT NULL ,
	department  varchar(25) NOT NULL,
	designation varchar(25) not null,
	[enrolment_no / staff_no] int NOT NULL unique
);
...
(
	...
	_book_author varchar(25) not null,
	shelve_ID int not null foreign key references shelves(shelve_ID),
);
CREATE TABLE shelves
(
	 shelve_ID int not null primary key,
	 shelve_subject varchar(25) not null,
	 Shelve_no int not null unique,
	 almirah_no int not null unique
);
